<?php
	...
	$index_header_fileContents = file_get_contents(APP_PATH . "portable_files/portable_index_header.php");
	$index_footer_fileContents = file_get_contents(APP_PATH . "portable_files/portable_index_footer.php");

	// Create view1.html
	$view1_fp = fopen($tmp_dir_path . "app/view1.html", "w");
	$view1_fileContents = file_get_contents(APP_PATH . "portable_files/portable_view1.php");
	...
	foreach ($srid_array as $srid) {
		...
		$narrative_fileContents = file_get_contents(APP_PATH . "portable_files/portable_narrative.php?id=" . $srid);
	...
	foreach ($srid_array as $srid) {
		...
		$subNarrative_fileContents = file_get_contents(APP_PATH . "portable_files/portable_subNarrative.php?id=" . $srid);
	...
	foreach ($srid_array as $srid) {
		...
		$appendix_fileContents = file_get_contents(APP_PATH . "portable_files/portable_appendix.php?id=" . $srid);
